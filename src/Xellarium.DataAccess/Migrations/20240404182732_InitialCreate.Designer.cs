...
namespace Xellarium.DataAccess.Migrations
{
    ...
    [Migration("20240404182732_InitialCreate")]
            ...
            modelBuilder.Entity("Xellarium.BusinessLogic.Models.Rule", b =>
                {
                    ...
                    b.Property<int>("NeighbourhoodType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Xellarium.BusinessLogic.Models.Rule", b =>
                {
                    ...
                    b.OwnsOne("Xellarium.BusinessLogic.Models.GenericRule", "GenericRule", b1 =>
                        {
                            b1.Property<int>("RuleId")
                                .HasColumnType("integer");

                            b1.Property<string>("StateTransitionsJson")
                                .HasColumnType("text");
